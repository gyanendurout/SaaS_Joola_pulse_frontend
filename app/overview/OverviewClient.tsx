      ...
      {section === 'kpis' && (
        <>
          <div className="section">
            ...
            <div className="kpi-grid">
              <KpiCard variant="joola" label="POTENTIAL AMBASSADORS" src="Instagram · pipeline-flagged · all-time"
              ...
              <div className={'kpi ' + (data.responseRate > 0 ? 'joola' : 'warn')}>
                ...
                {data.responseRate > 0 ? (
                  ...
                  <div className="delta" style={{ color: 'var(--fg-4)' }}>Pending setup — see note below</div>
                )}
              </div>
              <KpiCard
                ...
                delta={data.avgResponseTimeMins == null ? 'Pending setup — see note below' : 'min · 13-wk avg'}
          ...
          <div className="card card-pad-lg">
            ...
            <div>
              {[
                ...
                { type: 'fan',       desc: `${data.ambassadors} potential ambassadors identified (pipeline-flagged)`, when: 'all-time' },
